...
/*   Updated: 2022/10/21 10:47:34 by fcadet           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
err_t		proc_stdin(alg_t alg, opts_t opts) {
	char		*hash;
	uint8_t		*stdin_mem;
	uint128_t	mem_sz;
...
int			main(int argc, char **argv) {
	...
	err |= err_2_flag(proc_stdin(alg, opts));
